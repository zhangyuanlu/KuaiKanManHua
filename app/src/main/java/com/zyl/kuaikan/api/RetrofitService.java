...
public interface RetrofitService {
    ...
    Observable<UserBean> tryToLogin(@Query("phone") String userName, @Query("password") String password, @Query("remember") String remember, @Query("code") String code);
    @POST("v1/passport/login/pc/user_mobile_login")
    Observable<UserBean> tryToLogin(@Query("phone") String userName, @Query("password") String password, @Query("remember") String remember);
    @POST("v1/passport/login/pc/user_mobile_login")
    Observable<UserBean> tryToLogin(@Query("phone") String userName, @Query("password") String password);
    ...
    Observable<UserBean> getVerifyCode(@Query("phone")String phoneNum, @Query("smscode_type")String codeType);
